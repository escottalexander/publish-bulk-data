# 🏗 An experiment in storing bulk data onchain
Follow the steps listed below to view the site and play around with costs of storing data in various ways onchain.

# Built useing Scaffold-ETH-2:
